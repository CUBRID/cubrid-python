...
class IssueTest(unittest.TestCase):
        ...
        def test_connect(self):
                ...
                try:
                    ...
                    errorValue=str(e)
                    print errorValue
                    self.assertEquals(errorValue,"(-30, 'ERROR: CCI, -30, Invalid url string')")
        ...
        def test_execute(self):
                ...
                try:
                    ...
                    errorValue=str(e)
                    print errorValue
                    self.assertEquals(errorValue,"(-493, 'ERROR: DBMS, -493, Syntax: syntax error, unexpected IdName ')")
                ...
                try:
                    ...
                    self.assertEquals(errorValue,'(-493, "ERROR: DBMS, -493, Syntax: syntax error, unexpected \')\' ")')
                try:
        ...
        def test_executeParam(self):
                ...
                try:
                    ...
                    errorValue=str(e)
                    print errorValue
                    self.assertEquals(errorValue,"(-2014, 'ERROR: CLIENT, -2014, Some parameter not binded')")
                ...
                try:
                    ...
                    errorValue=str(e)
                    print errorValue
                    self.assertEquals(errorValue,'(-494, "ERROR: DBMS, -494, Semantic: The number of attributes(2) and values(3) are not equal. insert into issue (nameid, age) values ( cast(\'1\' as integer),  cast(\'58\' as integer), null)")')
